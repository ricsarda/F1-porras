...
grandes_premios = {
    ...
    "Austria": {"fecha": "2025-06-29", "sprint": False},
    ...
    "Rusia": {"fecha": "2025-09-28", "sprint": False},
...
pilotos = [
    ...
    "Oliver Bearman",
    "Carlos Sainz",
    "Franco Colapinto"  # Añadido según tu solicitud
]
...
st.subheader("Predicciones registrada")
